...
$.fn.block = function(opts) {
    return this.each(function() {
        ...
        //if ($.browser.msie)   //[2014.12.19]
        if ($.support.checkOn)   //[2014.12.19]
...
var m_isIE = false;
//alert(m_ua);
if (m_ua.match("MSIE") || m_ua.match("Trident")) {
	//$(‘.ie’).show();
	m_isIE = true;
} else {
	//$(‘.not_ie’).show();
...
var ie6 = $.support.checkOn && /MSIE 6.0/.test(navigator.userAgent);
var pageBlock = null;
var pageBlockEls = [];
...
//alert(msg);
    ...
    var lyr1 = ($.support.checkOn) ? $('<iframe class="blockUI" style="z-index:' + z++ + ';border:none;margin:0;padding:0;position:absolute;width:100%;height:100%;top:0;left:0" src="javascript:false;"></iframe>')
...
//alert(msg);
    ...
    if (!opts.applyPlatformOpacityRules || !($.support.opacity && /Linux/.test(navigator.platform)))
...
//alert(msg);
    ...
    var expr = $.support.checkOn && (!$.boxModel || $('object,embed', full ? null : el).length > 0);
    if (ie6 || expr) {
